...
function forms(formSelector, modalTimerId) {
  ...
  function showThanksModal(message) {
    ...
    Object(_modal__WEBPACK_IMPORTED_MODULE_0__["toggleModalWindow"])('.modal', modalTimerId)
...
function slider({
  ...
  function transitionSlide(step) {
    slidesField.style.transform = `translateX(-${step}px)`
  }
...
window.addEventListener('DOMContentLoaded', function () {
  const modalTimerId = setTimeout(
    () => Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["toggleModalWindow"])('.modal', modalTimerId),
    300000
  )
